            ...
            <div class="col-lg-12">
              <div class="main-profile ">
                <div class="row">
                  ...
                  <?php
                  include'../koneksi.php';
                  $qry_user=mysqli_query($sambung,"select * from user where username='".$_SESSION['username']."'");
                  $data_user=mysqli_fetch_array($qry_user);
                  ?>
                  <div class="col-lg-4 align-self-center">
                    <div class="main-info header-text">
                        <a href="#"><span><?=$_SESSION['status']?></span></a>
                      <p>Nama:<b style="color:white; margin-left:47px;">  <?=$_SESSION['nama']?></b></p>
          ...
          <div class="gaming-library profile-library">
            <div class="col-lg-12">
              <div class="heading-section">
                <h4><em>History</em> Anda</h4>
              </div>
                <table class="table">
                  <thead class="bg-light text-dark" style="border:5px solid pink;">
                        <th>No</th><th>Foto Produk</th><th>Nama Produk</th>
                        <th>Jumlah</th><th>Tgl Beli</th><th>Tgl Sampai</th><th>Status</th>
                  </thead>
                  <tbody class="text-light">
                          <?php
                          include'../koneksi.php';
                          $qry_history=mysqli_query($sambung,"select * from transaksi where id_user = '".$_SESSION['id_user']."' order by id_transaksi desc ");
                          $no=0;
                          while($data_history=mysqli_fetch_array($qry_history)){
                            ...
                            <tr>
                              ...
                              <td><?=$data_history['tgl_selesai']?></td>
