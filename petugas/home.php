            ...
            <div class="row">
              <div class="col-lg-7">
                <div class="header-text">
                  <h6><span style="color:hotpink;">Welcome</span> <?=$_SESSION['nama']?></h6>
                  <h4><em>CARI</em> barang yang sesuai dengan selera anda</h4>
    ...
    while($data_barang=mysqli_fetch_array($qry_barang)){
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="item" style=" padding-bottom:20px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius:10px; "><br>
              ...
              <a href="ubah_barang.php?id_produk=<?=$data_barang['id_produk']?>" style="margin-left:16px; position:absolute; margin-top:-25px;"><i class="fa fa-gear"></i></a>
              </div>
            </div>
        </div>
        <?php
